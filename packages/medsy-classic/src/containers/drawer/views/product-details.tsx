  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <Scrollbar className="details-scrollbar flex-grow">
        <div style={{ position: 'relative', width: '100%', height: '300px' }} className="flex flex-col p-30px pt-0">
          <figure className="flex items-center justify-center w-full h-360px overflow-hidden rounded mb-30px">
            <Image src={state.item.image} alt={`${state.item.name}-img`} fill objectFit="cover"/>
          </figure>
